...
function FallbackGallery({ images }: { images: ImageItem[] }) {
	...
	return (
		<div className="flex flex-col items-center justify-center h-full bg-[#0c1527] border border-white/5 rounded-xl p-6 text-center">
			<p className="text-slate-400 mb-6 font-medium">
				El navegador no soporta WebGL 3D. Cargando vista de catálogo estándar:
			</p>
			<div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full max-w-4xl max-h-96 overflow-y-auto pr-2">
				{normalizedImages.map((img, i) => (
					<div key={i} className="group relative aspect-[4/3] rounded-lg overflow-hidden border border-white/10 bg-[#060b16]">
						<img
